<footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h4>Contract Us<span class="line"></span></h4>

<!--                        <p>Tel: +860-631-7795<br />Fax: +860-631-7796  <br />Email: admin@bangmoddorm.com  </p>-->

                         <ul class="nav nav-pills">
                             <li><img src="images/fb.png" style="width: 15%;height: 6%"><img src="images/twitter logo.png" style="width: 15%;height: 6%;margin-left: 5%;"><img src="images/LINE-icon.png" style="width: 15%;height: 6%;margin-left: 5%;"></li>
...
<!--                        <ul data-facebook-action="recommend" data-url="#" class="socialcount socialcount-small recommend grade-a">
                        ...
                        <br />
<!--                        <p class="copy">All content &copy; 2013 <a href="http://appsarea.com/"></a></p>-->

                    </div>
                    <div class="col-md-4">
                        <h4>About Bangmod Dorm</h4>
<!--                        <p>Our website has service for booking </p>
                        <p>dormitory around KMUTT</p>-->
                        <p>You can find dormitory detail, booking dormitory and view a comment</p>
<!--                        <p>that make you choice to make a decision.</p>-->
                    </div>
                    <div class="col-md-4" style="padding-left:10%">
                        <h4>Sponsors<span class="line"></span></h4>
                        <ul class="thumbnails" style="margin-top: -5%;">
                            <li class="span2">
                                <div class="">
                                    <img src="images/logo-kmutt1.png" style="width: 60%;height: 10%;margin-left: -2%" />
                                </div>
                            </li>
                        </ul>
                    </div>
