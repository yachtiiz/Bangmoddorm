                    ...
                    <div class="row">
                        <div class="span9">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="span9">
                                        <legend><span>Member</span> Profile</legend>
                                    </div>
                                    <div class="span3">
                                        <label>Username
                                            <input type="text" value="Ajchariya"/>
                                        </label>
                                    </div>
                                    <div class="span3">
                                        <label>Type
                                ...
                                <div class="row">
                                    ...
                                    <div class="span9">
                                        <legend><span>Member</span> name</legend>
                                    </div>
                                    ...
                                    <div class="span3">
                                        <label>
                                            <input type="text" value="Arunaramwong" />
                                        </label>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="span9">
                                        <legend><span>Member</span> contact details</legend>
                                    </div>
                                    <div class="span3">
                                        <label>Identity Card Number
                                            <input type="text" value="110220021200331"/>
                                        </label>
                                    </div>

                                    <div class="span3">
                                        <label>Email address 
                                            <input type="text" value ="jorchy@abcmail.com" />
                                        </label>
                                    </div>	
                                ...
                                <div class="row">
                                    <div class="span9">
                                        <legend><span>Member</span> address</legend>
                                    </div>

                                    <div class="span3">
                                        <label>Address
                                            <textarea class="address_box" rows="3">Prachautid Road Soi 76</textarea>
                                        </label>
                                    </div>				
                                    ...
                                    <a href="" class="btn btn-primary btn-large book-now pull-left">Back</a>                                
                            </fieldset>
                            </form>
                        </div>
                    </div>
