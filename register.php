        ...
        <div class="span9" style="margin-bottom:100px">
            ...
            <form id="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="span3">
                        <input id="idcard" name="idcard" type="text" class="form-control" placeholder="Citizen ID" />
                    </div>
                    ...
                    <div class="span3">
                        <input id="tel" name="tel" type="text" class="form-control" placeholder="+(66)90-971-1786" />
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="span3">
                        ...
                        <input id="province" name="province" type="text" class="form-control" placeholder="District"/>
                        <br>
                        <input id="zipcode" name="zipcode" type="text" class="form-control" placeholder="Zip Code"/>
                    </div>

                    <div class="span3">
                        <input id="city" name="city" type="text" class="form-control" placeholder="Province"/>
                        <br>
