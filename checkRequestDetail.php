                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="span3">
                                    ...
                                    <label>Request Status
                                        <p class="lead"><?php echo $row["approval"] ?> </p>
                                    </label>
                                </div>
                                <div class="span3">
                                    <label>Evidence
                            ...
                            <div class="row">
                                <div class="span9">
                                    ...
                                    <a id="reject_button" class="btn btn-primary book-now pull-right" style="margin-left: 15px">Reject</a>
                                    <a href="index.php?chose_page=checkRequestDorm" class="btn btn-primary btn-large book-now pull-right">Back</a>
                                    <br />
                                    <br />
                                </div>
                            </div>
