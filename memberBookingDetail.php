                    ...
                    <div class="row">
                        <form action="" method="post">
                            <div class="span8">
                                ...
                                <div class="pull-left strong">Booking Time</div><div class="pull-right"><?php echo $book_row["date"] ?></div><br />
                                <div class="pull-left strong">Make Contract Before</div><div class="pull-right "><?php echo $book_row["expire_date"] ?> </div><br />
                                <br>
