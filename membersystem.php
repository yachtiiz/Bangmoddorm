                        ...
                        <div class="span9">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="span4">
                                        <a href="checkMemberBooking.jsp"><button type="button" class="btn btn-primary btn-lg btn-block book-now2">Check Your Booking History</button></a><br><br>
                                ...
                                <div class="row">
                                    <div class="span5">
                                        <button type="submit" class="btn btn-primary book-now">Change Your Profile</button>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
