            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td><h3>Facilities</h3></td>
                    <td><h3>24-hour front desk</h3></td>
                    <td><h3>car park</h3></td>
                </tr>
                <tr>
                    <td></td>
                    <td><h3>executive floor</h3></td>
                    <td><h3>luggage storage</h3></td>
                </tr>
                <tr>
                    <td></td>
                    <td><h3>room service</h3></td>
                    <td><h3>airport transfer</h3></td>
                </tr>
                <tr>
                    <td></td>
                    <td><h3>concierge</h3></td>
                    <td><h3>meeting facilities</h3></td>
                </tr>
                <tr>
                    <td><h3>Sport And Recreation</h3></td>
                    <td><h3>Swimming Pool</h3></td>
                    <td><h3>Spa</h3></td>
                </tr>
                <tr>
                    <td></td>
                    <td><h3>Sauna</h3></td>
                    <td><h3>Tennis Court</h3></td>
                </tr>
                <tr>
                    <td><h3>Rate</h3></td>
                    <td><h3 style="color:gold"> &#9733;&#9733;&#9733;&#9733;&#9734;</h3></td>
                    <td></td>
                </tr>
            </table>
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td><img src="css/images/rooms/MyPlace2_Room1.jpg" class="img-thumbnail"/></td>
                    <td class="span5"><h3>Superior Room</h3>Air Conditioner <br> Table <br> Wardrobe <br> Balcony <br> Price : 20$/Month<br><br>
                        <a href="book.jsp"><button type="button" class="btn btn-success book-now">Booking</button></a><br><br>
                        <!-- Button trigger modal -->
                        <button class="btn btn-primary btn-lg book-now" data-toggle="modal" data-target="#myModal">
                            Detail
                        </button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Superior Room</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="span7">
                                                ...
                                                <br>
                                                <div class="custom_container">
                                                    <div class="pull-left strong">Areas of room : 8m x 4m</div>
                                                </div>

                                                <div class="custom_container">
                                                    <div class="pull-left strong" style="color:green">Number Room Available : 20</div>
                                                </div>
                                                <div class="pull-right"><h3>Price 20$/Month</h3></div>
                                            </div>
